...
print("🛡️ Converting Dashboard to Quantitative Research Station...")
    ...
    <div className="min-h-screen bg-slate-950 text-white flex relative font-sans">
      ...
      <main className="flex-1 p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="p-6 bg-slate-900/50 rounded-2xl border border-slate-800">
                <div className="text-slate-500 text-xs uppercase font-bold mb-2">Execution Engine</div>
                <div className="text-3xl font-bold text-slate-500">Tradetron (External)</div>
            </div>
        </div>
