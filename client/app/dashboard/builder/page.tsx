    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 pb-20">
        <div className="col-span-1 space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <button onClick={handleBacktest} disabled={backtestLoading} className="w-full py-4 bg-slate-800 border border-slate-600 rounded-lg font-bold flex items-center justify-center gap-2 hover:bg-slate-700 transition-transform">
